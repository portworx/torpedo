...
// Source: pkg/crud/externalstorage/externalstorage.go
//
// Generated by this command:
//
//	mockgen -source=pkg/crud/externalstorage/externalstorage.go -destination=pkg/snapshot/controllers/snapshot.mock.go -package=controllers
//
...
// ListSnapshotDatas mocks base method.
func (m *MockOps) ListSnapshotDatas(namespace string) (*v1.VolumeSnapshotDataList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListSnapshotDatas", namespace)
	ret0, _ := ret[0].(*v1.VolumeSnapshotDataList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListSnapshotDatas indicates an expected call of ListSnapshotDatas.
func (mr *MockOpsMockRecorder) ListSnapshotDatas(namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSnapshotDatas", reflect.TypeOf((*MockOps)(nil).ListSnapshotDatas), namespace)
}
