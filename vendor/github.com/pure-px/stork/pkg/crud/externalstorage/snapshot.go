...
type SnapshotOps interface {
	...
	ListSnapshotDatas(namespace string) (*snapv1.VolumeSnapshotDataList, error)
}
...
func (c *Client) ListSnapshotDatas(namespace string) (*snapv1.VolumeSnapshotDataList, error) {
	if err := c.initClient(); err != nil {
		return nil, err
	}
