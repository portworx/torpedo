...
// checks if the MetadataForIAM type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataForIAM{}

// MetadataForIAM Metadata for IAM.
type MetadataForIAM struct {
...
func (o *MetadataForIAM) GetResourceNames() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *MetadataForIAM) GetResourceNamesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ResourceNames) {
		return nil, false
	}
...
func (o *MetadataForIAM) HasResourceNames() bool {
	if o != nil && !IsNil(o.ResourceNames) {
		return true
	}
...
func (o *MetadataForIAM) SetResourceNames(v map[string]string) {
	o.ResourceNames = &v
}

func (o MetadataForIAM) MarshalJSON() ([]byte, error) {
...
func (o MetadataForIAM) ToMap() (map[string]interface{}, error) {
...
type NullableMetadataForIAM struct {
	value *MetadataForIAM
	isSet bool
}

func (v NullableMetadataForIAM) Get() *MetadataForIAM {
	return v.value
}

func (v *NullableMetadataForIAM) Set(val *MetadataForIAM) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataForIAM) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataForIAM) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataForIAM(val *MetadataForIAM) *NullableMetadataForIAM {
	return &NullableMetadataForIAM{value: val, isSet: true}
}

func (v NullableMetadataForIAM) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataForIAM) UnmarshalJSON(src []byte) error {
	v.isSet = true
