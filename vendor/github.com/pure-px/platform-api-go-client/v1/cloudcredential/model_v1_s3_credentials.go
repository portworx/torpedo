...
// checks if the V1S3Credentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1S3Credentials{}

// V1S3Credentials S3 or S3 compatible credentials.
...
func (o *V1S3Credentials) GetConfigS3AccessKey() string {
	if o == nil || IsNil(o.ConfigS3AccessKey) {
		var ret string
		return ret
	}
...
func (o *V1S3Credentials) GetConfigS3SecretKey() string {
	if o == nil || IsNil(o.ConfigS3SecretKey) {
		var ret string
		return ret
	}
...
func (o V1S3Credentials) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ConfigS3AccessKey) {
		toSerialize["config/s3/access_key"] = o.ConfigS3AccessKey
	}
	if !IsNil(o.ConfigS3SecretKey) {
