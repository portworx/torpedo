...
// checks if the V1ListAvailableApplicationsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListAvailableApplicationsResponse{}

// V1ListAvailableApplicationsResponse ListAvailableApplicationsResponse is the request to the ListAvailableApplications API.
...
func (o V1ListAvailableApplicationsResponse) ToMap() (map[string]interface{}, error) {
