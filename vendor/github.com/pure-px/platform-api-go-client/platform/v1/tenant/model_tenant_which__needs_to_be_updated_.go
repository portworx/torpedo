...
// checks if the TenantWhichNeedsToBeUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantWhichNeedsToBeUpdated{}
...
func (o TenantWhichNeedsToBeUpdated) ToMap() (map[string]interface{}, error) {
