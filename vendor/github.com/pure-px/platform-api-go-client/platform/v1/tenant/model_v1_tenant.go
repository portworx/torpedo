...
// checks if the V1Tenant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1Tenant{}
...
func (o V1Tenant) ToMap() (map[string]interface{}, error) {
