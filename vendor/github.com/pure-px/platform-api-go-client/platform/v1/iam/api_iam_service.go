...
/*
IAMServiceCreateIAM CreateIAM API creates a new IAM role-binding.
...
// Name of the attribute to sort results by.   - FIELD_UNSPECIFIED: Unspecified, do not use.  - EMAIL: Sorting based on the email of the iam.
func (r ApiIAMServiceListIAMRequest) SortSortBy(sortSortBy string) ApiIAMServiceListIAMRequest {
...
func (r ApiIAMServiceListIAMRequest) SortSortOrder(sortSortOrder string) ApiIAMServiceListIAMRequest {
...
func (a *IAMServiceAPIService) IAMServiceListIAMExecute(r ApiIAMServiceListIAMRequest) (*V1ListIAMResponse, *http.Response, error) {
	...
	if r.actorId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "actorId", r.actorId, "")
	}
	if r.accountId != nil {
...
type ApiIAMServiceListIAMPermissionsRequest struct {
	ctx context.Context
	ApiService *IAMServiceAPIService
}

func (r ApiIAMServiceListIAMPermissionsRequest) Execute() (*V1ListIAMPermissionsResponse, *http.Response, error) {
	return r.ApiService.IAMServiceListIAMPermissionsExecute(r)
}

/*
IAMServiceListIAMPermissions ListIAMPermissions API list permissions for Roles in IAM.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiIAMServiceListIAMPermissionsRequest
*/
func (a *IAMServiceAPIService) IAMServiceListIAMPermissions(ctx context.Context) ApiIAMServiceListIAMPermissionsRequest {
	return ApiIAMServiceListIAMPermissionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return V1ListIAMPermissionsResponse
func (a *IAMServiceAPIService) IAMServiceListIAMPermissionsExecute(r ApiIAMServiceListIAMPermissionsRequest) (*V1ListIAMPermissionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V1ListIAMPermissionsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IAMServiceAPIService.IAMServiceListIAMPermissions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
