...
// checks if the V1ListIAMResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListIAMResponse{}

// V1ListIAMResponse ListIAMResponse is the response to the ListIAM API and contains the list of IAMs visible to the caller.
...
func (o V1ListIAMResponse) ToMap() (map[string]interface{}, error) {
