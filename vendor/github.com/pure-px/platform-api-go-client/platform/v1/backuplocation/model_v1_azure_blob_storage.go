...
// checks if the V1AzureBlobStorage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1AzureBlobStorage{}

// V1AzureBlobStorage Azure blob storage location.
...
func (o V1AzureBlobStorage) ToMap() (map[string]interface{}, error) {
