...
// checks if the V1GoogleCloudStorage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1GoogleCloudStorage{}

// V1GoogleCloudStorage Google cloud storage location.
...
func (o V1GoogleCloudStorage) ToMap() (map[string]interface{}, error) {
