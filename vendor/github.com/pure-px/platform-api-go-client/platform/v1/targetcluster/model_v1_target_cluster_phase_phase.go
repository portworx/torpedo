...
// V1TargetClusterPhasePhase Supported values of phase of target cluster.   - PHASE_UNSPECIFIED: Must be set in the proto file; ignore.  - CONNECTED: Represents target cluster is connected to control plane.  - DISCONNECTED: Represents target cluster is disconnected from control plane if heartbeat is not received for three consecutive cycles.  - FAILED: Represents target cluster failed to setup agent.  - DELETING: Represents target cluster deletion in progress.
type V1TargetClusterPhasePhase string

// List of v1TargetClusterPhasePhase
const (
	V1TARGETCLUSTERPHASEPHASE_PHASE_UNSPECIFIED V1TargetClusterPhasePhase = "PHASE_UNSPECIFIED"
	V1TARGETCLUSTERPHASEPHASE_CONNECTED V1TargetClusterPhasePhase = "CONNECTED"
	V1TARGETCLUSTERPHASEPHASE_DISCONNECTED V1TargetClusterPhasePhase = "DISCONNECTED"
	V1TARGETCLUSTERPHASEPHASE_FAILED V1TargetClusterPhasePhase = "FAILED"
	V1TARGETCLUSTERPHASEPHASE_DELETING V1TargetClusterPhasePhase = "DELETING"
)
