...
// checks if the MetadataOfTheTargetClusterResourceMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataOfTheTargetClusterResourceMeta{}

// MetadataOfTheTargetClusterResourceMeta Metadata of the target cluster(Resource Meta).
...
func (o *MetadataOfTheTargetClusterResourceMeta) GetResourceNames() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *MetadataOfTheTargetClusterResourceMeta) GetResourceNamesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ResourceNames) {
		return nil, false
	}
...
func (o *MetadataOfTheTargetClusterResourceMeta) HasResourceNames() bool {
	if o != nil && !IsNil(o.ResourceNames) {
		return true
	}
...
func (o *MetadataOfTheTargetClusterResourceMeta) SetResourceNames(v map[string]string) {
	o.ResourceNames = &v
}
...
func (o MetadataOfTheTargetClusterResourceMeta) ToMap() (map[string]interface{}, error) {
