...
// checks if the V1TargetCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1TargetCluster{}
...
func (o V1TargetCluster) ToMap() (map[string]interface{}, error) {
