...
// V1ApplicationPhasePhase AppStatus determines status of an application.   - PHASE_UNSPECIFIED: Must be set in the proto file; ignore.  - PENDING: Application yet to be installed.  - DEPLOYING: Application deployment on the target cluster in progress.  - SUCCEEDED: Installed successfully.  - FAILED: Application failed to install.  - DELETING: Application is being deleted.
type V1ApplicationPhasePhase string

// List of v1ApplicationPhasePhase
const (
	V1APPLICATIONPHASEPHASE_PHASE_UNSPECIFIED V1ApplicationPhasePhase = "PHASE_UNSPECIFIED"
	V1APPLICATIONPHASEPHASE_PENDING V1ApplicationPhasePhase = "PENDING"
	V1APPLICATIONPHASEPHASE_DEPLOYING V1ApplicationPhasePhase = "DEPLOYING"
	V1APPLICATIONPHASEPHASE_SUCCEEDED V1ApplicationPhasePhase = "SUCCEEDED"
	V1APPLICATIONPHASEPHASE_FAILED V1ApplicationPhasePhase = "FAILED"
	V1APPLICATIONPHASEPHASE_DELETING V1ApplicationPhasePhase = "DELETING"
)
