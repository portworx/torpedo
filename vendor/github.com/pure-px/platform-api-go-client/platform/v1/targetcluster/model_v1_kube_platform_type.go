...
// V1KubePlatformType kubeplatform values.   - TYPE_UNSPECIFIED: Unsepecified.  - AWS: Aws platform.  - AZURE: Azure platform.  - OCP: Openshift cloud platform.  - GCP: Google cloud platform.  - VSPHERE: VMware vSphere.  - UNKNOWN: Unknown platform.
type V1KubePlatformType string

// List of v1KubePlatformType
const (
	V1KUBEPLATFORMTYPE_TYPE_UNSPECIFIED V1KubePlatformType = "TYPE_UNSPECIFIED"
	V1KUBEPLATFORMTYPE_AWS V1KubePlatformType = "AWS"
	V1KUBEPLATFORMTYPE_AZURE V1KubePlatformType = "AZURE"
	V1KUBEPLATFORMTYPE_OCP V1KubePlatformType = "OCP"
	V1KUBEPLATFORMTYPE_GCP V1KubePlatformType = "GCP"
	V1KUBEPLATFORMTYPE_VSPHERE V1KubePlatformType = "VSPHERE"
	V1KUBEPLATFORMTYPE_UNKNOWN V1KubePlatformType = "UNKNOWN"
)
