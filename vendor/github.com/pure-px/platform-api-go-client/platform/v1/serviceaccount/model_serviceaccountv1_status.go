...
// checks if the Serviceaccountv1Status type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Serviceaccountv1Status{}
...
func (o *Serviceaccountv1Status) GetSecretGenerationCount() int32 {
	if o == nil || IsNil(o.SecretGenerationCount) {
		var ret int32
		return ret
	}
...
func (o *Serviceaccountv1Status) GetLastSecretUpdateTime() time.Time {
	if o == nil || IsNil(o.LastSecretUpdateTime) {
		var ret time.Time
		return ret
	}
...
func (o Serviceaccountv1Status) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SecretGenerationCount) {
		toSerialize["secretGenerationCount"] = o.SecretGenerationCount
	}
	if !IsNil(o.LastSecretUpdateTime) {
