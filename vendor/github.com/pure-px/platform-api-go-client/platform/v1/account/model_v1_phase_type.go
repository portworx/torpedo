...
// V1PhaseType Type of phase the account is in currently should be one of the below.   - TYPE_UNSPECIFIED: Unspecified, do not use.  - ACTIVE: The account is in use and active.  - DELETE_PENDING: Deletion of account has not started.  - DELETE_IN_PROGRESS: Deletion of the account is scheduled and in progress.  - DELETE_FAILED: Deletion of account is failed
