...
// V1ProviderType Type of provider.   - TYPE_UNSPECIFIED: Type unspecified.  - AZURE: Azure Cloud.  - GOOGLE: Google Cloud.  - S3COMPATIBLE: S3 Compatible.  - UNSTRUCTURED: Unstructured credentials.
type V1ProviderType string

// List of v1ProviderType
const (
	V1PROVIDERTYPE_TYPE_UNSPECIFIED V1ProviderType = "TYPE_UNSPECIFIED"
	V1PROVIDERTYPE_AZURE V1ProviderType = "AZURE"
	V1PROVIDERTYPE_GOOGLE V1ProviderType = "GOOGLE"
	V1PROVIDERTYPE_S3_COMPATIBLE V1ProviderType = "S3COMPATIBLE"
	V1PROVIDERTYPE_UNSTRUCTURED V1ProviderType = "UNSTRUCTURED"
)
