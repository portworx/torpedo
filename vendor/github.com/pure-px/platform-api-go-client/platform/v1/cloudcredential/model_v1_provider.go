...
// checks if the V1Provider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1Provider{}

// V1Provider Provider associated with created credentials.
...
func NewV1Provider() *V1Provider {
	this := V1Provider{}
	var cloudProvider V1ProviderType = V1PROVIDERTYPE_TYPE_UNSPECIFIED
...
func (o V1Provider) ToMap() (map[string]interface{}, error) {
