...
type Projectv1Status struct {
	...
	AssociatedResources *map[string]int32 `json:"associatedResources,omitempty"`
}
...
func (o *Projectv1Status) GetAssociatedResources() map[string]int32 {
...
// and a boolean to check if the value has been set.
func (o *Projectv1Status) GetAssociatedResourcesOk() (*map[string]int32, bool) {
	if o == nil || IsNil(o.AssociatedResources) {
		return nil, false
	}
...
func (o *Projectv1Status) HasAssociatedResources() bool {
	if o != nil && !IsNil(o.AssociatedResources) {
		return true
	}
...
// SetAssociatedResources gets a reference to the given map[string]int32 and assigns it to the AssociatedResources field.
func (o *Projectv1Status) SetAssociatedResources(v map[string]int32) {
