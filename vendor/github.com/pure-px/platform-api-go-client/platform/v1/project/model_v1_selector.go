...
type V1Selector struct {
	...
	Filters []V1SelectorFilter `json:"filters,omitempty"`
}
...
func (o *V1Selector) GetFilters() []V1SelectorFilter {
	if o == nil || IsNil(o.Filters) {
		var ret []V1SelectorFilter
		return ret
	}
	return o.Filters
}
...
func (o *V1Selector) GetFiltersOk() ([]V1SelectorFilter, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
// SetFilters gets a reference to the given []V1SelectorFilter and assigns it to the Filters field.
func (o *V1Selector) SetFilters(v []V1SelectorFilter) {
	o.Filters = v
}
