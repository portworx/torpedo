...
// checks if the V1Filter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1Filter{}
...
func NewV1Filter() *V1Filter {
	this := V1Filter{}
	var appResource V1ApplicationResourceType = V1APPLICATIONRESOURCETYPE_TYPE_UNSPECIFIED
	this.AppResource = &appResource
	var infraResource V1InfraResourceType = V1INFRARESOURCETYPE_TYPE_UNSPECIFIED
...
func (o V1Filter) ToMap() (map[string]interface{}, error) {
