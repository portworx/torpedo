...
func (a *ProjectServiceAPIService) ProjectServiceListProjectsExecute(r ApiProjectServiceListProjectsRequest) (*V1ListProjectsResponse, *http.Response, error) {
	...
	if r.queryAppResource != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "query.appResource", r.queryAppResource, "")
	} else {
		var defaultValue string = "TYPE_UNSPECIFIED"
		r.queryAppResource = &defaultValue
	}
	if r.queryInfraResource != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "query.infraResource", r.queryInfraResource, "")
	} else {
		var defaultValue string = "TYPE_UNSPECIFIED"
		r.queryInfraResource = &defaultValue
	}
	if r.queryResourceId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "query.resourceId", r.queryResourceId, "")
	}
	if r.sortSortBy != nil {
