...
type ApiAccountServiceCreateAccountRequest struct {
	...
	v1Account1 *V1Account1
}

// account to be created
func (r ApiAccountServiceCreateAccountRequest) V1Account1(v1Account1 V1Account1) ApiAccountServiceCreateAccountRequest {
	r.v1Account1 = &v1Account1
	return r
}

func (r ApiAccountServiceCreateAccountRequest) Execute() (*V1Account1, *http.Response, error) {
...
//  @return V1Account1
func (a *AccountServiceAPIService) AccountServiceCreateAccountExecute(r ApiAccountServiceCreateAccountRequest) (*V1Account1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V1Account1
	)
	...
	if r.v1Account1 == nil {
		return localVarReturnValue, nil, reportError("v1Account1 is required and must be specified")
	}
...
func (r ApiAccountServiceGetAccountRequest) Execute() (*V1Account1, *http.Response, error) {
...
// Execute executes the request
//  @return V1Account1
func (a *AccountServiceAPIService) AccountServiceGetAccountExecute(r ApiAccountServiceGetAccountRequest) (*V1Account1, *http.Response, error) {
	var (
...
func (r ApiAccountServiceUpdateAccountRequest) Execute() (*V1Account1, *http.Response, error) {
...
// Execute executes the request
//  @return V1Account1
func (a *AccountServiceAPIService) AccountServiceUpdateAccountExecute(r ApiAccountServiceUpdateAccountRequest) (*V1Account1, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"account.meta.uid"+"}", url.PathEscape(parameterValueToString(r.accountMetaUid, "accountMetaUid")), -1)
