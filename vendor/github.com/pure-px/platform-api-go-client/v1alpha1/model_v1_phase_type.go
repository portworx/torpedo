...
// V1PhaseType Type of phase the tenant is in currently should be one of the below.   - TYPE_UNSPECIFIED: Unspecified, do not use.  - ACTIVE: The tenant is in use and active.  - DELETE_PENDING: Deletion of tenant has not started.  - DELETE_IN_PROGRESS: Deletion of the tenant is scheduled and in progress.
