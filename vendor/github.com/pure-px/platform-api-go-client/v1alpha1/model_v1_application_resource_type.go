...
const (
	V1APPLICATIONRESOURCETYPE_TYPE_UNSPECIFIED V1ApplicationResourceType = "TYPE_UNSPECIFIED"
	V1APPLICATIONRESOURCETYPE_PDS_DEPLOYMENT V1ApplicationResourceType = "PDS_DEPLOYMENT"
	V1APPLICATIONRESOURCETYPE_PDS_BACKUP V1ApplicationResourceType = "PDS_BACKUP"
	V1APPLICATIONRESOURCETYPE_PDS_RESTORE V1ApplicationResourceType = "PDS_RESTORE"
	V1APPLICATIONRESOURCETYPE_BAAS_BACKUP V1ApplicationResourceType = "BAAS_BACKUP"
)
