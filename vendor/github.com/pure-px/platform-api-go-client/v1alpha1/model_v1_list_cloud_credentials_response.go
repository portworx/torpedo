...
// checks if the V1ListCloudCredentialsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListCloudCredentialsResponse{}
...
func (o V1ListCloudCredentialsResponse) ToMap() (map[string]interface{}, error) {
