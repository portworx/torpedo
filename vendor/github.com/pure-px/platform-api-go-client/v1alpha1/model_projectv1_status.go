...
func NewProjectv1Status() *Projectv1Status {
	...
	var phase V1PhaseType1 = V1PHASETYPE1_TYPE_UNSPECIFIED
	this.Phase = &phase
	return &this
}
...
func (o *Projectv1Status) GetPhase() V1PhaseType1 {
...
// and a boolean to check if the value has been set.
func (o *Projectv1Status) GetPhaseOk() (*V1PhaseType1, bool) {
	if o == nil || IsNil(o.Phase) {
		return nil, false
	}
	return o.Phase, true
...
func (o *Projectv1Status) SetPhase(v V1PhaseType1) {
	o.Phase = &v
}
