...
// StatusPhase - PHASE_UNSPECIFIED: Invitation status unspecified  - PENDING: Invitation acceptance pending  - ACCEPTED: Invitation Accepted
...
const (
	...
	STATUSPHASE_ACCEPTED StatusPhase = "ACCEPTED"
)
