...
// checks if the V1ListProjectsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListProjectsResponse{}
...
func (o V1ListProjectsResponse) ToMap() (map[string]interface{}, error) {
