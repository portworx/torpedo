...
// checks if the V1ListInvitationsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ListInvitationsResponse{}
...
func (o V1ListInvitationsResponse) ToMap() (map[string]interface{}, error) {
