...
type ApiRestoreServiceCreateRestoreRequest struct {
	...
	namespaceId string
	restoreServiceCreateRestoreBody *RestoreServiceCreateRestoreBody
}

func (r ApiRestoreServiceCreateRestoreRequest) RestoreServiceCreateRestoreBody(restoreServiceCreateRestoreBody RestoreServiceCreateRestoreBody) ApiRestoreServiceCreateRestoreRequest {
	r.restoreServiceCreateRestoreBody = &restoreServiceCreateRestoreBody
	return r
}
...
RestoreServiceCreateRestore CreateRestore API creates the Restore resource.
 ...
 @param namespaceId UID of the namespace where restore will be created.
...
func (a *RestoreServiceAPIService) RestoreServiceCreateRestoreExecute(r ApiRestoreServiceCreateRestoreRequest) (*V1Restore, *http.Response, error) {
	...
	if r.restoreServiceCreateRestoreBody == nil {
		return localVarReturnValue, nil, reportError("restoreServiceCreateRestoreBody is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.restoreServiceCreateRestoreBody
...
type ApiRestoreServiceGetRestorabilityMatrixRequest struct {
	ctx context.Context
	ApiService *RestoreServiceAPIService
}

func (r ApiRestoreServiceGetRestorabilityMatrixRequest) Execute() (*V1RestorabilityMatrix, *http.Response, error) {
	return r.ApiService.RestoreServiceGetRestorabilityMatrixExecute(r)
}

/*
RestoreServiceGetRestorabilityMatrix GetRestorabilityMatrix API returns the compatibility matrix for restore.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRestoreServiceGetRestorabilityMatrixRequest
*/
func (a *RestoreServiceAPIService) RestoreServiceGetRestorabilityMatrix(ctx context.Context) ApiRestoreServiceGetRestorabilityMatrixRequest {
	return ApiRestoreServiceGetRestorabilityMatrixRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RestoreServiceAPIService) RestoreServiceGetRestorabilityMatrixExecute(r ApiRestoreServiceGetRestorabilityMatrixRequest) (*V1RestorabilityMatrix, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V1RestorabilityMatrix
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RestoreServiceAPIService.RestoreServiceGetRestorabilityMatrix")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/pds/v1/restores:restorabilityMatrix"
