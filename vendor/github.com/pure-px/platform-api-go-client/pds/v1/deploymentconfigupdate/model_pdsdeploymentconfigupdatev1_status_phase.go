...
// Pdsdeploymentconfigupdatev1StatusPhase Enum for Phase of the Deployment config update.   - PHASE_UNSPECIFIED: Phase is unspecified.  - FAILED: Deployment config update failed.  - QUEUED: Deployment config update is queued.  - IN_PROGRESS: Deployment config update is in progress.  - COMPLETED: Deployment config update is completed.  - REQUEUED: Deployment config update is requeued.
type Pdsdeploymentconfigupdatev1StatusPhase string

// List of pdsdeploymentconfigupdatev1StatusPhase
const (
	PDSDEPLOYMENTCONFIGUPDATEV1STATUSPHASE_PHASE_UNSPECIFIED Pdsdeploymentconfigupdatev1StatusPhase = "PHASE_UNSPECIFIED"
	PDSDEPLOYMENTCONFIGUPDATEV1STATUSPHASE_FAILED Pdsdeploymentconfigupdatev1StatusPhase = "FAILED"
	PDSDEPLOYMENTCONFIGUPDATEV1STATUSPHASE_QUEUED Pdsdeploymentconfigupdatev1StatusPhase = "QUEUED"
	PDSDEPLOYMENTCONFIGUPDATEV1STATUSPHASE_IN_PROGRESS Pdsdeploymentconfigupdatev1StatusPhase = "IN_PROGRESS"
	PDSDEPLOYMENTCONFIGUPDATEV1STATUSPHASE_COMPLETED Pdsdeploymentconfigupdatev1StatusPhase = "COMPLETED"
	PDSDEPLOYMENTCONFIGUPDATEV1STATUSPHASE_REQUEUED Pdsdeploymentconfigupdatev1StatusPhase = "REQUEUED"
)
