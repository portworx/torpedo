...
// MetadataOfTheDeploymentResource Metadata of the deployment resource.
...
func (o *MetadataOfTheDeploymentResource) GetResourceNames() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *MetadataOfTheDeploymentResource) GetResourceNamesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ResourceNames) {
		return nil, false
	}
...
func (o *MetadataOfTheDeploymentResource) HasResourceNames() bool {
	if o != nil && !IsNil(o.ResourceNames) {
		return true
	}
...
func (o *MetadataOfTheDeploymentResource) SetResourceNames(v map[string]string) {
	o.ResourceNames = &v
}
