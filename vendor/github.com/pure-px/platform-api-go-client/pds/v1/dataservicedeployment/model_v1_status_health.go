...
// V1StatusHealth Enum for Health of the DataService Deployment.   - HEALTH_UNSPECIFIED: Health is unspecified.  - AVAILABLE: DataService Deployment is Available.  - PARTIALLY_AVAILABLE: DataService Deployment is PartiallyAvailable.  - UNAVAILABLE: DataService Deployment is Unavailable.  - NOT_APPLICABLE: DataService Deployment is deleted from cluster.
