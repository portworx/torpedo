...
func (a *DataServiceDeploymentServiceAPIService) DataServiceDeploymentServiceCreateDataServiceDeploymentExecute(r ApiDataServiceDeploymentServiceCreateDataServiceDeploymentRequest) (*V1DataServiceDeployment, *http.Response, error) {
	...
	localVarPath := localBasePath + "/pds/v1/namespaces/{namespaceId}/dataServiceDeployments"
...
type ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest struct {
	ctx context.Context
	ApiService *DataServiceDeploymentServiceAPIService
	namespaceId string
	dataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody *DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody
}

func (r ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest) DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody(dataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody) ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest {
	r.dataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody = &dataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody
	return r
}

func (r ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest) Execute() (*V1DataServiceDeployment, *http.Response, error) {
	return r.ApiService.DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupExecute(r)
}

/*
DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackup CreateDataServiceDeploymentWithScheduledBackup API creates both Deployment and backup configuration resources.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param namespaceId UID of the namespace resource where this DataService deployment will be created.
 @return ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest
*/
func (a *DataServiceDeploymentServiceAPIService) DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackup(ctx context.Context, namespaceId string) ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest {
	return ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest{
		ApiService: a,
		ctx: ctx,
		namespaceId: namespaceId,
...
// Execute executes the request
//  @return V1DataServiceDeployment
func (a *DataServiceDeploymentServiceAPIService) DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupExecute(r ApiDataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupRequest) (*V1DataServiceDeployment, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DataServiceDeploymentServiceAPIService.DataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/pds/v1/namespaces/{namespaceId}/dataServiceDeployments:createWithScheduledBackup"
	localVarPath = strings.Replace(localVarPath, "{"+"namespaceId"+"}", url.PathEscape(parameterValueToString(r.namespaceId, "namespaceId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody == nil {
		return localVarReturnValue, nil, reportError("dataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dataServiceDeploymentServiceCreateDataServiceDeploymentWithScheduledBackupBody
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
