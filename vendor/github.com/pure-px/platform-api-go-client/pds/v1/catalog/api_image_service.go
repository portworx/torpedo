...
// Filter images based on enabled flag.   - ENABLED_UNSPECIFIED: List all images.  - TRUE: List only enabled images.  - FALSE: List only disabled images.
func (r ApiImageServiceListImagesRequest) Enabled(enabled string) ApiImageServiceListImagesRequest {
	r.enabled = &enabled
	return r
}
