...
type ApiTemplateDefinitionServiceGetTemplateSampleRequest struct {
	ctx context.Context
	ApiService *TemplateDefinitionServiceAPIService
	id string
}

func (r ApiTemplateDefinitionServiceGetTemplateSampleRequest) Execute() (*V1TemplateSample, *http.Response, error) {
	return r.ApiService.TemplateDefinitionServiceGetTemplateSampleExecute(r)
}

/*
TemplateDefinitionServiceGetTemplateSample GetTemplateSample API returns the template sample for a given template id.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id UID of the template sample.
 @return ApiTemplateDefinitionServiceGetTemplateSampleRequest
*/
func (a *TemplateDefinitionServiceAPIService) TemplateDefinitionServiceGetTemplateSample(ctx context.Context, id string) ApiTemplateDefinitionServiceGetTemplateSampleRequest {
	return ApiTemplateDefinitionServiceGetTemplateSampleRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return V1TemplateSample
func (a *TemplateDefinitionServiceAPIService) TemplateDefinitionServiceGetTemplateSampleExecute(r ApiTemplateDefinitionServiceGetTemplateSampleRequest) (*V1TemplateSample, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V1TemplateSample
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemplateDefinitionServiceAPIService.TemplateDefinitionServiceGetTemplateSample")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/pds/v1/catalog/templateDefinition/samples/{id}"
...
/*
TemplateDefinitionServiceListRevisions List API lists all the revision
...
type ApiTemplateDefinitionServiceListRevisions2Request struct {
	ctx context.Context
	ApiService *TemplateDefinitionServiceAPIService
	v1ListRevisionsRequest *V1ListRevisionsRequest
}

// Request parameters for listing revisions.
func (r ApiTemplateDefinitionServiceListRevisions2Request) V1ListRevisionsRequest(v1ListRevisionsRequest V1ListRevisionsRequest) ApiTemplateDefinitionServiceListRevisions2Request {
	r.v1ListRevisionsRequest = &v1ListRevisionsRequest
	return r
}

func (r ApiTemplateDefinitionServiceListRevisions2Request) Execute() (*V1ListRevisionsResponse, *http.Response, error) {
	return r.ApiService.TemplateDefinitionServiceListRevisions2Execute(r)
}

/*
TemplateDefinitionServiceListRevisions2 List API lists all the revision

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiTemplateDefinitionServiceListRevisions2Request
*/
func (a *TemplateDefinitionServiceAPIService) TemplateDefinitionServiceListRevisions2(ctx context.Context) ApiTemplateDefinitionServiceListRevisions2Request {
	return ApiTemplateDefinitionServiceListRevisions2Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return V1ListRevisionsResponse
func (a *TemplateDefinitionServiceAPIService) TemplateDefinitionServiceListRevisions2Execute(r ApiTemplateDefinitionServiceListRevisions2Request) (*V1ListRevisionsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemplateDefinitionServiceAPIService.TemplateDefinitionServiceListRevisions2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/pds/v1/catalog/templateDefinition/revisions:search"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.v1ListRevisionsRequest == nil {
		return localVarReturnValue, nil, reportError("v1ListRevisionsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v1ListRevisionsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
