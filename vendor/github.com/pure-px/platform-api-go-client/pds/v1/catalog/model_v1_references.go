...
func (o *V1References) GetDataServiceVersionId() string {
...
// and a boolean to check if the value has been set.
func (o *V1References) GetDataServiceVersionIdOk() (*string, bool) {
	if o == nil || IsNil(o.DataServiceVersionId) {
		return nil, false
	}
...
func (o *V1References) HasDataServiceVersionId() bool {
	if o != nil && !IsNil(o.DataServiceVersionId) {
		return true
	}
...
func (o *V1References) SetDataServiceVersionId(v string) {
