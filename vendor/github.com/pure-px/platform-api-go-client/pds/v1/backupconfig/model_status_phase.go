...
// StatusPhase Enum for Phases of the backup configuration.   - PHASE_UNSPECIFIED: Unspecified state.  - PREPARING: Preparing state before creation is successful.  - APPLIED: Applied state when create/update is successful.  - UPDATING: Updating state.  - FAILED: Failed state.  - SUSPENDED: Suspended state.
type StatusPhase string

// List of StatusPhase
const (
	STATUSPHASE_PHASE_UNSPECIFIED StatusPhase = "PHASE_UNSPECIFIED"
	STATUSPHASE_PREPARING StatusPhase = "PREPARING"
	STATUSPHASE_APPLIED StatusPhase = "APPLIED"
	STATUSPHASE_UPDATING StatusPhase = "UPDATING"
