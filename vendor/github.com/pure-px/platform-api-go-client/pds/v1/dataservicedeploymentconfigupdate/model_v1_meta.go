...
func (o *V1Meta) GetResourceNames() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *V1Meta) GetResourceNamesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.ResourceNames) {
		return nil, false
	}
...
func (o *V1Meta) HasResourceNames() bool {
	if o != nil && !IsNil(o.ResourceNames) {
		return true
	}
...
func (o *V1Meta) SetResourceNames(v map[string]string) {
	o.ResourceNames = &v
}
