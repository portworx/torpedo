...
| cluster_id | [ string](#string) | cluster ID for which namespaces need to be fetched |
| project_id | [ string](#string) | project ID for which namespaces need to be fetched |
| label | [ string](#string) | for label based filtering of the namespaces |
