...
| Field | Type | Description |
| ----- | ---- | ----------- |
| permissions | [repeated string](#string) | permssions is list of permissions (-- api-linter: core::0132::response-unknown-fields=disabled aip.dev/not-precedent: We really need this field to list permissions for roles in IAM. --) |
 <!-- end Fields -->
 <!-- end HasFields -->
