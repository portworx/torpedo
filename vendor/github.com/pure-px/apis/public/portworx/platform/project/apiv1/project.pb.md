...
| resource_selector | [ public.portworx.common.v1.ResourceSelector](#publicportworxcommonv1resourceselector) | Filtering list of projects based on the provided resource details.. |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| deployments | [repeated string](#string) | Resource ids of deployments. |
