...
| semantic_version | [ string](#string) | Semantic version of the template used to identify template schema and latest revison for the given template instance kind |
...
| config | [ Config](#config) | Desired configuration of the tempalate. |
...
| ACITVE | 1 | Template instance is active |
