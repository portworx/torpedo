...
var file_public_portworx_common_apiv1_selector_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_public_portworx_common_apiv1_selector_proto_goTypes = []interface{}{
	(Selector_Operator)(0),                  // 0: public.portworx.common.v1.Selector.Operator
	(*Selector)(nil),                        // 1: public.portworx.common.v1.Selector
	(*ResourceSelector)(nil),                // 2: public.portworx.common.v1.ResourceSelector
	(*Selector_Filter)(nil),                 // 3: public.portworx.common.v1.Selector.Filter
	(*ResourceSelector_ResourceFilter)(nil), // 4: public.portworx.common.v1.ResourceSelector.ResourceFilter
	(InfraResource_Type)(0),                 // 5: public.portworx.common.v1.InfraResource.Type
}
var file_public_portworx_common_apiv1_selector_proto_depIdxs = []int32{
	3, // 0: public.portworx.common.v1.Selector.filters:type_name -> public.portworx.common.v1.Selector.Filter
	4, // 1: public.portworx.common.v1.ResourceSelector.infra_resource_filters:type_name -> public.portworx.common.v1.ResourceSelector.ResourceFilter
	0, // 2: public.portworx.common.v1.Selector.Filter.op:type_name -> public.portworx.common.v1.Selector.Operator
	5, // 3: public.portworx.common.v1.ResourceSelector.ResourceFilter.resource_type:type_name -> public.portworx.common.v1.InfraResource.Type
	0, // 4: public.portworx.common.v1.ResourceSelector.ResourceFilter.op:type_name -> public.portworx.common.v1.Selector.Operator
