...
| deployment_target_name | [ string](#string) | Deployment Target Name associated with the backup. |
...
| data_service_name | [ string](#string) | Name of the data service of deployment. |
