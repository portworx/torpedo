...
func (c *dataServiceDeploymentServiceClient) CreateDataServiceDeploymentWithScheduledBackup(ctx context.Context, in *CreateDataServiceDeploymentWithScheduledBackupRequest, opts ...grpc.CallOption) (*DataServiceDeployment, error) {
	out := new(DataServiceDeployment)
	err := c.cc.Invoke(ctx, DataServiceDeploymentService_CreateDataServiceDeploymentWithScheduledBackup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataServiceDeploymentServiceClient) GetKeyPerformanceIndicators(ctx context.Context, in *ListDataServiceDeploymentsRequest, opts ...grpc.CallOption) (*KeyPerformanceIndicators, error) {
	...
	err := c.cc.Invoke(ctx, DataServiceDeploymentService_GetKeyPerformanceIndicators_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
