...
| resource_template | [ Template](#template) | Resource Settings Template. |
| application_template | [ Template](#template) | Application Template. |
| storage_template | [ Template](#template) | Storage Template. |
 <!-- end Fields -->
 <!-- end HasFields -->
