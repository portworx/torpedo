...
const (
	...
	UNAVAILABLE V1DeploymentTopologyStatusHealth = "UNAVAILABLE"
	PARTIALLY_AVAILABLE V1DeploymentTopologyStatusHealth = "PARTIALLY_AVAILABLE"
	AVAILABLE V1DeploymentTopologyStatusHealth = "AVAILABLE"
)
