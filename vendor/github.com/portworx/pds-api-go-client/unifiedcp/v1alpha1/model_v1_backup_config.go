...
// checks if the V1BackupConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1BackupConfig{}
...
func (o V1BackupConfig) ToMap() (map[string]interface{}, error) {
