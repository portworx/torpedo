...
// checks if the GooglerpcStatus3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GooglerpcStatus3{}
...
func (o GooglerpcStatus3) ToMap() (map[string]interface{}, error) {
