...
// checks if the V1References4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1References4{}
...
func (o V1References4) ToMap() (map[string]interface{}, error) {
