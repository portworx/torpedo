...
// checks if the GooglerpcStatus2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GooglerpcStatus2{}

// GooglerpcStatus2 struct for GooglerpcStatus2
type GooglerpcStatus2 struct {
...
func (o GooglerpcStatus2) MarshalJSON() ([]byte, error) {
...
func (o GooglerpcStatus2) ToMap() (map[string]interface{}, error) {
...
type NullableGooglerpcStatus2 struct {
	value *GooglerpcStatus2
	isSet bool
}

func (v NullableGooglerpcStatus2) Get() *GooglerpcStatus2 {
	return v.value
}

func (v *NullableGooglerpcStatus2) Set(val *GooglerpcStatus2) {
	v.value = val
	v.isSet = true
}

func (v NullableGooglerpcStatus2) IsSet() bool {
	return v.isSet
}

func (v *NullableGooglerpcStatus2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGooglerpcStatus2(val *GooglerpcStatus2) *NullableGooglerpcStatus2 {
	return &NullableGooglerpcStatus2{value: val, isSet: true}
}

func (v NullableGooglerpcStatus2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGooglerpcStatus2) UnmarshalJSON(src []byte) error {
	v.isSet = true
