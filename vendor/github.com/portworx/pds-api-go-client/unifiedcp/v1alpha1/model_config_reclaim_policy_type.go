...
const (
	CONFIGRECLAIMPOLICYTYPE_RECLAIM_POLICY_TYPE_UNSPECIFIED ConfigReclaimPolicyType = "RECLAIM_POLICY_TYPE_UNSPECIFIED"
	CONFIGRECLAIMPOLICYTYPE_DELETE ConfigReclaimPolicyType = "DELETE"
	CONFIGRECLAIMPOLICYTYPE_RETAIN ConfigReclaimPolicyType = "RETAIN"
)
