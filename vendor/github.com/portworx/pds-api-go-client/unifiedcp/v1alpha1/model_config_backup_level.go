...
const (
	CONFIGBACKUPLEVEL_BACKUP_LEVEL_UNSPECIFIED ConfigBackupLevel = "BACKUP_LEVEL_UNSPECIFIED"
	CONFIGBACKUPLEVEL_SNAPSHOT ConfigBackupLevel = "SNAPSHOT"
	CONFIGBACKUPLEVEL_INCREMENTAL ConfigBackupLevel = "INCREMENTAL"
)
