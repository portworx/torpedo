...
const (
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_PHASE_UNSPECIFIED V1DeploymentTopologyStatusPhase = "PHASE_UNSPECIFIED"
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_IN_PROGRESS V1DeploymentTopologyStatusPhase = "IN_PROGRESS"
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_PARTIAL_SUCCESS V1DeploymentTopologyStatusPhase = "PARTIAL_SUCCESS"
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_SUCCESS V1DeploymentTopologyStatusPhase = "SUCCESS"
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_DELETE_PENDING V1DeploymentTopologyStatusPhase = "DELETE_PENDING"
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_DELETING V1DeploymentTopologyStatusPhase = "DELETING"
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_FAILED V1DeploymentTopologyStatusPhase = "FAILED"
	V1DEPLOYMENTTOPOLOGYSTATUSPHASE_TIMED_OUT V1DeploymentTopologyStatusPhase = "TIMED_OUT"
)
