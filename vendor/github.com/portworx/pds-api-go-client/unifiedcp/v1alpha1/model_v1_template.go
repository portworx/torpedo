...
type V1Template struct {
	...
	Values *map[string]ProtobufAny4 `json:"values,omitempty"`
}
...
func (o *V1Template) GetValues() map[string]ProtobufAny4 {
	if o == nil || IsNil(o.Values) {
		var ret map[string]ProtobufAny4
		return ret
	}
	return *o.Values
}
...
// SetValues gets a reference to the given map[string]ProtobufAny4 and assigns it to the Values field.
