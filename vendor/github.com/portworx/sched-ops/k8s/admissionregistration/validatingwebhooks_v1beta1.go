...
type ValidatingWebhookConfigurationV1beta1Ops interface {
	// GetValidatingWebhookConfigurationV1beta1 returns a given ValidatingWebhookConfiguration
	...
	CreateValidatingWebhookConfigurationV1beta1(req *hook.ValidatingWebhookConfiguration) (*hook.ValidatingWebhookConfiguration, error)
	// UpdateValidatingWebhookConfigurationV1beta1 updates given ValidatingWebhookConfiguration
	UpdateValidatingWebhookConfigurationV1beta1(*hook.ValidatingWebhookConfiguration) (*hook.ValidatingWebhookConfiguration, error)
