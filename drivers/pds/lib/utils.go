...
const (
	...
	cassandraStresImage = "docker.pwx.dev.purestorage.com/portworx/scylla:4.1.11"
	// postgresqlStressImage        = "portworx/torpedo-pgbench:pdsloadTest"
	postgresqlStressImage = "docker.pwx.dev.purestorage.com/portworx/torpedo-pgbench:pdsloadTest"
