...
import (
	. "github.com/portworx/torpedo/drivers/pxbackup/controller/cl_controller/cluster_manager/cluster/app_manager"
...
func NewDefaultCluster(clusterSpec *ClusterSpec) *Cluster {
	return NewCluster(clusterSpec, NewDefaultEntityManager[*Namespace]())
}
