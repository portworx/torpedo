...
func CreateBackupConfig(name string, deploymentId string, projectId string, backupLocationId string) (*automationModels.PDSBackupConfigResponse, error) {
	...
	createBackupConfigRequest.Create.BackupConfig = &automationModels.V1BackupConfig{
		...
		Config: &automationModels.Config{
			...
			BackupPolicy: &automationModels.V1BackupPolicyForBackupConfig{
				Id: &defaultBackupPolicy,
			},
...
// CreateScheduleBackup creates schedule backup config for the deployment
func CreateScheduleBackup(name string, deploymentId string, projectId string, backupLocationId string, scheduleId string) (*automationModels.PDSBackupConfigResponse, error) {
