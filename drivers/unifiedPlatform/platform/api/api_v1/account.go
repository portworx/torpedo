...
// AccountV2 struct
type ACCOUNT_API_V1 struct {
	ApiClientV2 *platformV2.APIClient
}

// GetClient updates the header with bearer token and returns the new client
func (AccountV2 *ACCOUNT_API_V1) getClient() (context.Context, *platformV2.AccountServiceAPIService, error) {
	log.Infof("Creating client from ACCOUNT_API_V1 package")
...
func (AccountV2 *ACCOUNT_API_V1) GetAccountList() ([]Account, *status.Response, error) {
...
func (AccountV2 *ACCOUNT_API_V1) GetAccount(accountID string) (Account, *status.Response, error) {
...
func (AccountV2 *ACCOUNT_API_V1) CreateAccount(accountName, displayName, userMail string) (Account, *status.Response, error) {
...
func (AccountV2 *ACCOUNT_API_V1) DeleteBackupLocation(accountId string) (*status.Response, error) {
	ctx, client, err := AccountV2.getClient()
	if err != nil {
