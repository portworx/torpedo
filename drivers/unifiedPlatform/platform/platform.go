...
type TargetClusterInterface interface {
	...
	DeleteTargetCluster(request *PlatformTargetClusterRequest, force bool) error
}
...
type ApplicationInterface interface {
	...
	UpdateApplicationInCluster(request *WorkFlowRequest) (*WorkFlowResponse, error)
}
...
type BackupPolicy interface {
	CreateBackupPolicy(*BackupPolicyRequest) (*BackupPolicyResponse, error)
	GetBackupPolicy(*BackupPolicyRequest) (*BackupPolicyResponse, error)
	DeleteBackupPolicy(*BackupPolicyRequest) error
	ListBackupPolicy(*BackupPolicyRequest) (*BackupPolicyResponse, error)
}
