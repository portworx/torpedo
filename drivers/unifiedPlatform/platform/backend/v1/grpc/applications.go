...
func (ApplicationGrpcV1 *PlatformGrpc) UpdateApplicationInCluster(appRequest *WorkFlowRequest) (*WorkFlowResponse, error) {
	applicationResponse := WorkFlowResponse{
	...
	//TODO: Complete the code while adopting grpc
