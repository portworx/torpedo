...
import (
	...
	"github.com/pure-px/torpedo/drivers/unifiedPlatform/pds"
	pdsapi "github.com/pure-px/torpedo/drivers/unifiedPlatform/pds/backend/v1/api"
	pdsGrpc "github.com/pure-px/torpedo/drivers/unifiedPlatform/pds/backend/v1/grpc"
	"github.com/pure-px/torpedo/drivers/unifiedPlatform/platform"
	platformapi "github.com/pure-px/torpedo/drivers/unifiedPlatform/platform/backend/v1/api"
	platformGrpc "github.com/pure-px/torpedo/drivers/unifiedPlatform/platform/backend/v1/grpc"
...
func GetPlatformRESTClientForAutomation(controlPlaneURL string, AccountId string) (platformapi.PLATFORM_API_V1, error) {
	...
	// Creating Platform Schedules api client
	scheudlev1Config := backupPolicyV1.NewConfiguration()
	scheudlev1Config.Host = endpointURL.Host
	scheudlev1Config.Scheme = endpointURL.Scheme
	scheudlev1ConfigClient := backupPolicyV1.NewAPIClient(scheudlev1Config)
	...
	return platformapi.PLATFORM_API_V1{
		...
		BackupPolicyV1Client:             scheudlev1ConfigClient,
		AccountID:                        AccountId,
	}, nil
}
