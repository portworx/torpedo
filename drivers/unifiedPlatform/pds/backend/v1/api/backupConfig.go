...
func (backupConf *PDS_API_V1) CreateBackupConfig(createBackupConfigRequest *automationModels.PDSBackupConfigRequest) (*automationModels.PDSBackupConfigResponse, error) {
	...
	backupConfigCreateBody := backupConfigV1.BackupConfigServiceCreateBackupConfigBody{
	...
	if *createBackupConfigRequest.Create.BackupConfig.Config.BackupPolicy.Id != "" {
		backupConfigCreateBody.BackupConfig.Config.BackupPolicy = &backupConfigV1.V1BackupPolicy{
			Id: createBackupConfigRequest.Create.BackupConfig.Config.BackupPolicy.Id,
		}
	}

	backupCreateRequest = backupCreateRequest.BackupConfigServiceCreateBackupConfigBody(backupConfigCreateBody)
