...
func (backupConf *PDS_API_V1) getBackupConfigClient() (context.Context, *backupConfigV1.BackupConfigServiceAPIService, error) {
	...
	backupConf.BackupV1APIClient.GetConfig().DefaultHeader = utils.GetDefaultHeader(token, backupConf.AccountID)
...
func (restore *PDS_API_V1) getRestoreClient() (context.Context, *restoreV1.RestoreServiceAPIService, error) {
	...
	restore.BackupV1APIClient.GetConfig().DefaultHeader = utils.GetDefaultHeader(token, restore.AccountID)
...
func (ds *PDS_API_V1) getDeploymentClient() (context.Context, *deploymentV1.DeploymentServiceAPIService, error) {
	...
	ds.BackupV1APIClient.GetConfig().DefaultHeader = utils.GetDefaultHeader(token, ds.AccountID)
