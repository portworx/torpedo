...
func (app *MySqlConfig) CopyBackupData(ctx context.Context, identifier string) error {
	return nil
}
...
func (app *MySqlConfig) StartData(command <-chan string, ctx context.Context) error {
	...
	var tableName = "mysql_table_" + RandomString(4)
...
func (app *MySqlConfig) GetReplicaDetails(context.Context) (ReplicaDetails, error) {
	return ReplicaDetails{}, errdefs.NotImplemented(fmt.Errorf("GetReplicaDetails is not implemented for Mysql"))
}

// AddDatabaseToCluster Adds database to AAG Cluster for SQL Server
func (app *MySqlConfig) AddDatabaseToCluster(ctx context.Context, databaseName string, clusterName string) error {
	return errdefs.NotImplemented(fmt.Errorf("AddDatabaseToCluster is not implemented for MySQl"))
}

// CreateNewDatabase creates a new database on the given data service
func (app *MySqlConfig) CreateNewDatabase(ctx context.Context, databaseName string, databaseDetails DefaultDatabase) error {
	return errdefs.NotImplemented(fmt.Errorf("CreateNewDatabase is not implemented for MySql"))
}

// GetDefaultNewDatabaseConfig will get default database config details
func (app *MySqlConfig) GetDefaultNewDatabaseConfig(databaseName string) DefaultDatabase {
	log.Warnf(fmt.Sprintf("GetDefaultNewDatabaseConfig is not implemented for MySql"))
	return DefaultDatabase{}
}

// ExecuteCommandOnPrimary executes given command on the primary node
func (app *MySqlConfig) ExecuteCommandOnPrimary(commands []string, ctx context.Context) ([]string, error) {
	return nil, errdefs.NotImplemented(fmt.Errorf("ExecuteCommandOnPrimary is not implemented for MySql"))
}

// Failover is not implemented for MySQL
func (app *MySqlConfig) Failover(ctx context.Context) error {
	return errdefs.NotImplemented(fmt.Errorf("Failover is not implemented for MySql"))
}

// GetDataserviceConfigurations returns the configuration of the dataservice
func (app *MySqlConfig) GetDataserviceConfigurations(ctx context.Context) (DatabaseConfiguration, error) {
	return DatabaseConfiguration{}, errdefs.NotImplemented(fmt.Errorf("GetDataserviceConfigurations is not implemented for MySql"))
}

// GetDatabaseDetails returns the database details
func (app *MySqlConfig) GetDatabaseDetails() Database {
	return app.Database
}
