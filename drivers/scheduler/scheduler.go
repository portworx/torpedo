...
type Driver interface {
	...
	CreateCsiSnapshotClass(snapClassName string, deleionPolicy string) (*volumesnapshotv1.VolumeSnapshotClass, error)
	...
	CreateCsiSnapshot(name string, namespace string, class string, pvc string) (*volumesnapshotv1.VolumeSnapshot, error)
	...
	CreateCsiSnapsForVolumes(*Context, string) (map[string]*volumesnapshotv1.VolumeSnapshot, error)

	// GetCsiSnapshots return snapshot lists for a volume
	GetCsiSnapshots(string, string) ([]*volumesnapshotv1.VolumeSnapshot, error)

	// ValidateCsiSnapshots validate csi snapshots in the context
	ValidateCsiSnapshots(*Context, map[string]*volumesnapshotv1.VolumeSnapshot) error
	...
	GetAllSnapshotClasses() (*volumesnapshotv1.VolumeSnapshotClassList, error)
