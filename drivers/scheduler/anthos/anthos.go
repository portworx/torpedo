...
import (
	...
	//"sigs.k8s.io/cluster-api/pkg/apis/deprecated/v1alpha4"
...
func (anth *anthos) GetCluster() (*v1alpha4.Cluster, error) {
...
func (anth *anthos) GetClusterStatus() (*v1alpha4.ClusterStatus, error) {
