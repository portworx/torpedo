...
func (d *dcos) CreateCsiSnapshotClass(snapClassName string, deleionPolicy string) (*volumesnapshotv1.VolumeSnapshotClass, error) {
...
func (d *dcos) CreateCsiSnapshot(name string, namespace string, class string, pvc string) (*volumesnapshotv1.VolumeSnapshot, error) {
...
func (d *dcos) CreateCsiSnapsForVolumes(ctx *scheduler.Context, snapClass string) (map[string]*volumesnapshotv1.VolumeSnapshot, error) {
...
func (d *dcos) GetCsiSnapshots(namespace string, pvcName string) ([]*volumesnapshotv1.VolumeSnapshot, error) {
...
func (d *dcos) ValidateCsiSnapshots(ctx *scheduler.Context, volSnapMa map[string]*volumesnapshotv1.VolumeSnapshot) error {
...
func (d *dcos) GetAllSnapshotClasses() (*volumesnapshotv1.VolumeSnapshotClassList, error) {
