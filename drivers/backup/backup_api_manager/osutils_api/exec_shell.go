...
// ExecShellRequest represents a backup_api_manager.Request for the osutils.ExecShell
...
// ExecShellResponse represents a backup_api_manager.Response for the osutils.ExecShell
