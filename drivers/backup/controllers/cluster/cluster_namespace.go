...
// ValidateSchedulerContextConfig represents the configuration to effectively validate scheduler-context
...
// DestroySchedulerContextConfig represents the configuration to effectively destroy scheduler-context
