...
func (p *PxbController) setClusterInfo(clusterName string, clusterInfo *ClusterInfo) {
...
func (p *PxbController) GetClusterInfo(clusterName string) (*ClusterInfo, bool) {
...
func (p *PxbController) delClusterInfo(clusterName string) {
...
func (p *PxbController) Cluster(clusterName string, kubeconfigPath string) *AddClusterConfig {
...
func (p *PxbController) DeleteCluster(clusterName string) error {
...
func (p *PxbController) getClusterStatus(clusterName string) (clusterStatusInfo, error) {
	clusterInfo, ok := p.GetClusterInfo(clusterName)
	if !ok {
...
func (p *PxbController) WaitForClusterCompletion(clusterName string) (api.ClusterInfo_StatusInfo_Status, error) {
