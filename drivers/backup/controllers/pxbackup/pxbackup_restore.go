...
//}
//
//func (p *PxBackupController) setRestoreInfo(restoreName string, restoreInfo *RestoreInfo) {
...
//}
//
//func (p *PxBackupController) GetRestoreInfo(restoreName string) (*RestoreInfo, bool) {
...
//}
//
//func (p *PxBackupController) delRestoreInfo(restoreName string) {
...
//}
//
//func (p *PxBackupController) Restore(restoreName string, backupName string, clusterName string) *CreateRestoreConfig {
...
//}
//
//func (p *PxBackupController) DeleteRestore(restoreName string) error {
...
//}
//
//func (p *PxBackupController) getRestoreStatus(restoreName string) (restoreStatusInfo, error) {
//	restoreInfo, ok := p.GetRestoreInfo(restoreName)
//	if !ok {
...
//}
//
//func (p *PxBackupController) WaitForRestoreCompletion(restoreName string) (api.RestoreInfo_StatusInfo_Status, error) {
...
//}
//
//func (p *PxBackupController) WaitForRestoreDeletion(restoreName string) error {
//	getRestoreStatus := func() interface{} {
//		status, err := p.getRestoreStatus(restoreName)
//		if err != nil {
//			return restoreStatusInfo{
