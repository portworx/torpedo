...
func (p *PxbController) setBackupLocationInfo(backupLocationName string, backupLocationInfo *BackupLocationInfo) {
...
func (p *PxbController) GetBackupLocationInfo(backupLocationName string) (*BackupLocationInfo, bool) {
...
func (p *PxbController) delBackupLocationInfo(backupLocationName string) {
...
func (p *PxbController) BackupLocation(backupLocationName string, cloudAccountName string, bucketName string) *AddBackupLocationConfig {
...
func (p *PxbController) DeleteBackupLocation(backupLocationName string) error {
