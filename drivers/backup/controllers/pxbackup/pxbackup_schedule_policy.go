...
//}
//
//func (p *PxBackupController) setSchedulePolicyInfo(schedulePolicyName string, schedulePolicyInfo *SchedulePolicyInfo) {
...
//}
//
//func (p *PxBackupController) GetSchedulePolicyInfo(schedulePolicyName string) (*SchedulePolicyInfo, bool) {
...
//}
//
//func (p *PxBackupController) delSchedulePolicyInfo(schedulePolicyName string) {
...
//}
//
//func (p *PxBackupController) IntervalSchedulePolicy(schedulePolicyName string, retain int64, minutes int64, incrCount uint64) *AddSchedulePolicyConfig {
...
//}
//
//func (p *PxBackupController) DailySchedulePolicy(schedulePolicyName string, retain int64, time string, incrCount uint64) *AddSchedulePolicyConfig {
//	return &AddSchedulePolicyConfig{
//		schedulePolicyName: schedulePolicyName,
...
//}
//
//func (p *PxBackupController) WeeklySchedulePolicy(schedulePolicyName string, retain int64, weekDay Weekday, time string, incrCount uint64) *AddSchedulePolicyConfig {
//	return &AddSchedulePolicyConfig{
//		schedulePolicyName: schedulePolicyName,
...
//}
//
//func (p *PxBackupController) MonthlySchedulePolicy(schedulePolicyName string, retain int64, date int64, time string, incrCount uint64) *AddSchedulePolicyConfig {
//	return &AddSchedulePolicyConfig{
//		schedulePolicyName: schedulePolicyName,
...
//}
//
//func (p *PxBackupController) DeleteSchedulePolicy(schedulePolicyName string) error {
