...
func (p *PxbController) setBackupInfo(backupName string, backupInfo *BackupInfo) {
...
func (p *PxbController) GetBackupInfo(backupName string) (*BackupInfo, bool) {
...
func (p *PxbController) delBackupInfo(backupName string) {
...
func (p *PxbController) getBackupUid(backupName string) (string, error) {
...
func (p *PxbController) Backup(backupName string, backupLocationName string, clusterName string, namespaces []string) *CreateBackupConfig {
...
func (p *PxbController) DeleteBackup(backupName string) error {
...
func (p *PxbController) getBackupStatus(backupName string) (backupStatusInfo, error) {
	backupInfo, ok := p.GetBackupInfo(backupName)
	if !ok {
...
func (p *PxbController) WaitForBackupCompletion(backupName string) (api.BackupInfo_StatusInfo_Status, error) {
...
func (p *PxbController) WaitForBackupDeletion(backupName string) error {
	getBackupStatus := func() interface{} {
		status, err := p.getBackupStatus(backupName)
		if err != nil {
			return backupStatusInfo{
