...
func (c *ClusterConfig) SetClusterController(controller *ClusterController) {
...
func NewCluster() *Cluster {
	...
	requestManager.SetRequestProcessorMap(
		map[RequestType]RequestProcessor{
			reflect.TypeOf(schedulerapi.ScheduleRequest{}): func(request Request) (Response, error) {
