...
func (d *gce) IsPxLiteCluster() bool {
...
func (d *gce) WaitForKVDBToBeHealthy(n node.Node, retryInterval time.Duration) error {
	return nil
}

func (d *gce) WaitDriverToBeInState(n node.Node, timeout time.Duration, state api.Status) error {
