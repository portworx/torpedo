...
func (d *gce) ValidateStorageCluster(endpointURL, endpointVersion string, autoUpdateComponents bool) error {
...
func (d *gce) UpdateAndValidateStorageCluster(cluster *v1.StorageCluster, f func(*v1.StorageCluster) *v1.StorageCluster, specGenUrl string, autoUpdateComponents bool) (*v1.StorageCluster, error) {
	// TODO: Add implementation
