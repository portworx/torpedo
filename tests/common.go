...
func ParseFlags() {
	...
	flag.StringVar(&torpedoJobName, torpedoJobNameFlag, defaultTorpedoJob, "Name of the torpedo job to use")
	flag.StringVar(&torpedoJobType, torpedoJobTypeFlag, defaultTorpedoJobType, "Name of the torpedo job to use")
	...
	if schedulerDriver, err = scheduler.Get(s); err != nil {
		...
		logrus.Fatalf("Cannot find monitor driver for %v. Err: %v\n", m, err)
