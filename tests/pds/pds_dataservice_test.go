...
var _ = Describe("{VerifyDataServiceExtensionsPostUpdate}", func() {

	JustBeforeEach(func() {
		StartTorpedoTest("VerifyDataServiceExtensionsPostUpdate", "Deploys, updates the configuration and then verifies if the new configuration exists", pdsLabels, 0)
	})
