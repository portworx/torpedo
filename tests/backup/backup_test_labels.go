...
var TestCaseLabelsMap = map[TestCaseName][]TestCaseLabel{
	...
	RebootNodesWhenBackupsAreInProgress:                                    {RebootNodesWhenBackupsAreInProgressLabel, vanillaPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FACDLabel, FADALabel, ocpPipeline, NonPxLabel, SkipTestLabel}, // Adding Skip label because of PB-3584
