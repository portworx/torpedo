...
const (
	...
	LargeResourceNamespaceBackup                                                       TestCaseName = "LargeResourceNamespaceBackup"
	RestartPXBackupDuringLargeResourceScheduledBackup                                  TestCaseName = "RestartPXBackupDuringLargeResourceScheduledBackup"
	RestartStorkDuringLargeResourceScheduledBackup                                     TestCaseName = "RestartStorkDuringLargeResourceScheduledBackup"
	LargeResourceBackupSync                                                            TestCaseName = "LargeResourceBackupSync"
	RebootNodesDuringLargeResourceScheduledBackup                                      TestCaseName = "RebootNodesDuringLargeResourceScheduledBackup"
	AutopilotEnabledBackupRestore                                                      TestCaseName = "AutopilotEnabledBackupRestore"
...
const (
	...
	LargeResourceNamespaceBackupLabel                                                       TestCaseLabel = "LargeResourceNamespaceBackup"
	RestartPXBackupDuringLargeResourceScheduledBackupLabel                                  TestCaseLabel = "RestartPXBackupDuringLargeResourceScheduledBackup"
	RestartStorkDuringLargeResourceScheduledBackupLabel                                     TestCaseLabel = "RestartStorkDuringLargeResourceScheduledBackup"
	LargeResourceBackupSyncLabel                                                            TestCaseLabel = "LargeResourceBackupSync"
	RebootNodesDuringLargeResourceScheduledBackupLabel                                      TestCaseLabel = "RebootNodesDuringLargeResourceScheduledBackup"
	AutopilotEnabledBackupRestoreLabel                                                      TestCaseLabel = "AutopilotEnabledBackupRestore"
	RebootNodesWhileCRRestoreIsInProgressLabel                                              TestCaseLabel = "RebootNodesWhileCRRestoreIsInProgress"
...
const (
	...
	ocpPxOCSPipeline TestCaseLabel = "ocp-px-ocs-pipeline"
	ocpOcsPipeline   TestCaseLabel = "ocp-ocs-pipeline"
)
...
const (
	...
	KubevirtAppLabelVanilla TestCaseLabel = "kubevirt-app-vanilla"
	KubevirtAppLabelOCP     TestCaseLabel = "kubevirt-app-ocp"
)
...
var TestCaseLabelsMap = map[TestCaseName][]TestCaseLabel{
	...
	BackupAndRestoreSyncDR:                                                             {BackupAndRestoreSyncDRLabel, SystemTest, PxBackupLabel, P2, vanillaPipeline, S3BackupLocationLabel, NfsBackupLocationLabel, PxLabel, DRPipelineLabel},
	...
	BackupCSIVolumesWithPartialSuccess:                                                 {BackupCSIVolumesWithPartialSuccessLabel, PartialBackupLabel, ocpPxOCSPipeline, S3BackupLocationLabel, NfsBackupLocationLabel, iksPipeline, SystemTest, PxBackupLabel, P1},
	...
	BackupStateTransitionForScheduledBackups:                                           {BackupStateTransitionForScheduledBackupsLabel, PartialBackupLabel, ocpPxOCSPipeline, S3BackupLocationLabel, NfsBackupLocationLabel, iksPipeline, SystemTest, PxBackupLabel, P0},
	BackupSyncBasicTest:                                                                {BackupSyncBasicTestLabel, allPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FACDLabel, FADALabel, ocpPipeline, NonPxLabel, aksPipeline, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	...
	BasicSelectiveRestore:                                                              {BasicSelectiveRestoreLabel, rkePipeline, SystemTest, PxBackupLabel, P0, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, PxLabel, ocpPipeline, NonPxLabel, aksPipeline, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	CancelAllRunningBackupJobs:                                                         {CancelAllRunningBackupJobsLabel, ocpPipeline, SystemTest, PxBackupLabel, P2, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, FACDLabel, PxLabel, FADALabel, NonPxLabel, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	CancelAllRunningRestoreJobs:                                                        {CancelAllRunningRestoreJobsLabel, ocpPipeline, SystemTest, PxBackupLabel, P2, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, FACDLabel, PxLabel, FADALabel, NonPxLabel, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	...
	CustomBackupRestoreWithKubevirtAndNonKubevirtNS:                                    {CustomBackupRestoreWithKubevirtAndNonKubevirtNSLabel, KubevirtAppLabel, KubevirtAppLabelVanilla, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P1, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	CustomResourceBackupAndRestore:                                                     {CustomResourceBackupAndRestoreLabel, rkePipeline, SystemTest, PxBackupLabel, P0, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, PxLabel, ocpPipeline, NonPxLabel, aksPipeline, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	CustomResourceRestore:                                                              {CustomResourceRestoreLabel, allPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, FACDLabel, FADALabel, ocpPipeline, NonPxLabel, aksPipeline, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	DefaultBackupRestoreWithKubevirtAndNonKubevirtNS:                                   {DefaultBackupRestoreWithKubevirtAndNonKubevirtNSLabel, KubevirtAppLabel, KubevirtAppLabelOCP, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	DeleteAllBackupObjects:                                                             {DeleteAllBackupObjectsLabel, rkePipeline, SystemTest, PxBackupLabel, P0, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, FACDLabel, PxLabel, FADALabel, ocpPipeline, NonPxLabel, aksPipeline, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	...
	DeleteBucketVerifyCloudBackupMissing:                                               {DeleteBucketVerifyCloudBackupMissingLabel, allPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FACDLabel, FADALabel, ocpPipeline, NonPxLabel, aksPipeline, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	...
	DeleteNSDeleteClusterRestore:                                                       {DeleteNSDeleteClusterRestoreLabel, ocpPipeline, SystemTest, PxBackupLabel, P0, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, FACDLabel, PxLabel, FADALabel, NonPxLabel, aksPipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	DeleteNfsExecutorPodWhileBackupAndRestoreInProgress:                                {DeleteNfsExecutorPodWhileBackupAndRestoreInProgressLabel, ocpPipeline, SystemTest, NfsBackupLocationLabel, PxBackupLabel, P2, PxLabel},
	...
	ExcludeDirectoryFileBackup:                                                         {ExcludeDirectoryFileBackupLabel, vanillaPipeline, SystemTest, PxBackupLabel, P1, NonPxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, KDMPLabel},
	ExcludeInvalidDirectoryFileBackup:                                                  {ExcludeInvalidDirectoryFileBackupLabel, vanillaPipeline, SystemTest, PxBackupLabel, P1, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, KDMPLabel, NonPxLabel},
	...
	KubeAndPxNamespacesSkipOnAllNSBackup:                                               {KubeAndPxNamespacesSkipOnAllNSBackupLabel, vanillaPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FACDLabel, FADALabel},
	KubevirtInPlaceRestoreWithReplaceAndRetain:                                         {KubevirtInPlaceRestoreWithReplaceAndRetainLabel, KubevirtAppLabel, KubevirtAppLabelOCP, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	KubevirtScheduledVMDelete:                                                          {KubevirtScheduledVMDeleteLabel, KubevirtAppLabel, KubevirtAppLabelVanilla, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	KubevirtUpgradeTest:                                                                {KubevirtUpgradeTestLabel, KubevirtAppLabel, KubevirtAppLabelVanilla, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P1, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	KubevirtVMBackupOrDeletionInProgress:                                               {KubevirtVMBackupOrDeletionInProgressLabel, KubevirtAppLabel, KubevirtAppLabelVanilla, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P1, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	KubevirtVMBackupRestoreWithDifferentStates:                                         {KubevirtVMBackupRestoreWithDifferentStatesLabel, KubevirtAppLabel, KubevirtAppLabelOCP, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	KubevirtVMBackupRestoreWithNodeSelector:                                            {KubevirtVMBackupRestoreWithNodeSelectorLabel, KubevirtAppLabel, KubevirtAppLabelVanilla, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	KubevirtVMMigrationTest:                                                            {KubevirtVMMigrationTestLabel, KubevirtAppLabel, KubevirtAppLabelOCP, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	KubevirtVMRestoreWithAfterChangingVMConfig:                                         {KubevirtVMRestoreWithAfterChangingVMConfigLabel, KubevirtAppLabel, KubevirtAppLabelVanilla, ocpPipeline, vanillaPipeline, SystemTest, PxBackupLabel, P1, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	...
	MultipleInPlaceRestoreSameTime:                                                     {MultipleInPlaceRestoreSameTimeLabel, allPipeline, SystemTest, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, FACDLabel, FADALabel, ocpPipeline, NonPxLabel, aksPipeline, gkePipeline, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, ocpOcsPipeline},
	...
	UninstallPxBackupAndRestoreFromTheBackup:                                           {UninstallPxBackupAndRestoreFromTheBackupLabel, rkePipeline, SystemTest, PxBackupLabel, P2, S3BackupLocationLabel, NfsBackupLocationLabel, PxLabel, SkipTestLabel}, // SkipTestLabel label will be removed once PB-9743 is fixed
	...
	// Added SkipTestLabel label because of China account unavailability.
	PartialBackupSuccessWithAzureEndpoint:                                  {PartialBackupSuccessWithAzureEndpointLabel, PartialBackupLabel, AzureBackupLocationLabel, ocpPipeline, SystemTest, PxBackupLabel, P2, SkipTestLabel},
	PartialBackupSuccessWithPxAndKDMPVolumes:                               {PartialBackupSuccessWithPxAndKDMPVolumesLabel, PartialBackupLabel, ocpPxOCSPipeline, S3BackupLocationLabel, NfsBackupLocationLabel, iksPipeline, SystemTest, PxBackupLabel, P0},
	PartialBackupSuccessWithPxVolumes:                                      {PartialBackupSuccessWithPxVolumesLabel, PartialBackupLabel, ocpPxOCSPipeline, S3BackupLocationLabel, NfsBackupLocationLabel, S3BackupLocationLabel, NfsBackupLocationLabel, iksPipeline, SystemTest, PxBackupLabel, P1},
	PartialBackupWithLowerStorkVersion:                                     {PartialBackupWithLowerStorkVersionLabel, PartialBackupLabel, ocpPxOCSPipeline, S3BackupLocationLabel, NfsBackupLocationLabel, iksPipeline, SystemTest, PxBackupLabel, P1},
	...
	RebootNodesWhenBackupsAreInProgress:                                    {RebootNodesWhenBackupsAreInProgressLabel, vanillaPipeline, SystemTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FACDLabel, FADALabel, ocpPipeline, NonPxLabel, SkipTestLabel, ocpOcsPipeline}, // Adding Skip label because of PB-3584
	...
	ScaleMongoDBWhileBackupAndRestore:                                      {ScaleMongoDBWhileBackupAndRestoreLabel, ocpPipeline, SystemTest, PxBackupLabel, P1, S3BackupLocationLabel, FACDLabel, PxLabel, FADALabel, NonPxLabel, NfsBackupLocationLabel, gkePipeline, iksPipeline, roksPipeline, ocpPxOCSPipeline, ocpOcsPipeline},
	...
	ShareBackupAndEdit:                                                     {ShareBackupAndEditLabel, vanillaPipeline, SystemTest, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, FADALabel, gkePipeline},
	...
	StorkUpgradeWithBackup:                                                 {StorkUpgradeWithBackupLabel, UpgradeTest, PxBackupLabel},
	...
	TimeTakenToDeleteBackupWithHeavyLoad:                                   {TimeTakenToDeleteBackupWithHeavyLoadLabel, vanillaPipeline, ScaleTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	UpdatesBackupOfUserFromAdmin:                                           {UpdatesBackupOfUserFromAdminLabel, vanillaPipeline, SystemTest, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, FBDALabel, iksPipeline, KDMPLabel, CsiOffloadLabel, CsiLabel, roksPipeline, SkipTestLabel}, // skipping due to PB-7496
	...
	TimeTakenToDeleteScheduleBackupWithHeavyLoadAfterSuspendingTheSchedule: {TimeTakenToDeleteScheduleBackupWithHeavyLoadAfterSuspendingTheScheduleLabel, vanillaPipeline, ScaleTest, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	...
	LargeResourceNamespaceBackup:                                           {LargeResourceNamespaceBackupLabel, ocpPipeline, ScaleTest, LargeResourceLabel, PxBackupLabel, P0, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	RestartPXBackupDuringLargeResourceScheduledBackup:                      {RestartPXBackupDuringLargeResourceScheduledBackupLabel, ocpPipeline, ScaleTest, LargeResourceLabel, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	RestartStorkDuringLargeResourceScheduledBackup:                         {RestartStorkDuringLargeResourceScheduledBackupLabel, ocpPipeline, ScaleTest, LargeResourceLabel, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel},
	...
	NamespaceBackupRestoreWithHugeConfigMap:                                {NamespaceBackupRestoreWithHugeConfigMapLabel, ocpPipeline, ScaleTest, PxBackupLabel, P1, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, LargeResourceLabel},
	...
	BasicBackupAndRestoreWithParallelBackupSchedule:                        {BasicBackupAndRestoreWithParallelBackupScheduleLabel, SystemTest, PxBackupLabel, ScaleTest, PxLabel},
