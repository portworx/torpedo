...
var TestCaseLabelsMap = map[TestCaseName][]TestCaseLabel{
	...
	BackupNetworkErrorTest:                                                             {BackupNetworkErrorTestLabel, vanillaPipeline, SystemTest, PxBackupLabel, P1, PxLabel, S3BackupLocationLabel, NfsBackupLocationLabel, SkipTestLabel}, // skipping due to PB-6856
	...
	ShareBackupAndEdit:                                                     {ShareBackupAndEditLabel, vanillaPipeline, SystemTest, PxBackupLabel, P2, PxLabel, S3BackupLocationLabel, FBDALabel, FADALabel, gkePipeline},
