		...
		Step("Taking backup of application from all clusters", func() {
			...
			for clusterName := range ClusterConfigPathMap {
				...
				go func(clusterName string) {
					...
					err = CreateBackupWithValidation(ctx, currentBackupName, clusterName, backupLocationName, backupLocationUid, backupAppContexts, labelSelectors, BackupOrgID, currentClusterUid, "", "", "", "")
					if err != nil {
