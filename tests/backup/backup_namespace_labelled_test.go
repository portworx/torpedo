...
var _ = Describe("{NamespaceLabelledBackupSharedWithDifferentAccessMode}", func() {, Label(TestCaseLabelsMap[NamespaceLabelledBackupSharedWithDifferentAccessMode]...), 
	var (
...
var _ = Describe("{BackupScheduleForOldAndNewNS}", func() {, Label(TestCaseLabelsMap[BackupScheduleForOldAndNewNS]...), 
	var (
		initialNSCount         int
		newNSCount             int
...
var _ = Describe("{ManualAndScheduledBackupUsingNamespaceAndResourceLabel}", func() {, Label(TestCaseLabelsMap[ManualAndScheduledBackupUsingNamespaceAndResourceLabel]...), 
	var (
		err                     error
...
var _ = Describe("{ScheduleBackupWithAdditionAndRemovalOfNS}", func() {, Label(TestCaseLabelsMap[ScheduleBackupWithAdditionAndRemovalOfNS]...), 
	var (
		err                      error
...
var _ = Describe("{ManualAndScheduleBackupUsingNSLabelWithMaxCharLimit}", func() {, Label(TestCaseLabelsMap[ManualAndScheduleBackupUsingNSLabelWithMaxCharLimit]...), 
	var (
		err                            error
		backupLocationUID              string
		cloudCredUID                   string
...
var _ = Describe("{NamespaceLabelledBackupOfEmptyNamespace}", func() {, Label(TestCaseLabelsMap[NamespaceLabelledBackupOfEmptyNamespace]...), 
	var (
		backupLocationUID           string
		cloudCredUID                string
		clusterUid                  string
