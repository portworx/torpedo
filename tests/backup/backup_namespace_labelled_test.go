...
var _ = Describe("{ManualAndScheduledBackupUsingNamespaceAndResourceLabel}", func() {
	...
	It("Manual, schedule backup and restore using namespace label and resource label", func() {
		...
		Step("Creating schedule backup with namespace label", func() {
			...
			appContextsExpectedInBackup := FilterAppContextsByNamespace(scheduledAppContexts, bkpNamespaces)
			firstScheduleBackupName, err = CreateScheduleBackupWithNamespaceLabelWithValidation(ctx, scheduleBackupName, SourceClusterName, backupLocationName, backupLocationUID, appContextsExpectedInBackup, nil, BackupOrgID, "", "", "", "", namespaceLabel, periodicSchPolicyName, periodicSchPolicyUid, nil)
...
var _ = Describe("{ScheduleBackupWithAdditionAndRemovalOfNS}", func() {
	...
	It("Perform schedule backup during which remove and add namespace and verify restoration of removed namespace", func() {
		...
		Step("Creating schedule backup with namespace label", func() {
			...
			scheduleName = fmt.Sprintf("%s-schedule-%v", BackupNamePrefix, time.Now().Unix())
			appContextsExpectedInBackup := FilterAppContextsByNamespace(scheduledAppContexts, bkpNamespaces)
			firstScheduleBackupName, err = CreateScheduleBackupWithNamespaceLabelWithValidation(ctx, scheduleName, SourceClusterName, backupLocationName, backupLocationUID, appContextsExpectedInBackup, nil, BackupOrgID, "", "", "", "", namespaceLabel, periodicSchPolicyName, periodicSchPolicyUid, nil)
...
var _ = Describe("{ManualAndScheduleBackupUsingNSLabelWithMaxCharLimit}", func() {
	...
	It("Manual, schedule backup and restore of single, multiple and all namespaces with namespace labeled as max character limit", func() {
		...
		Step("Creating a schedule backup for single namespace with namespace label filter", func() {
			...
			appContextsExpectedInBackup := FilterAppContextsByNamespace(scheduledAppContexts, []string{singleNamespace})
			firstSchBackupForSingleNS, err = CreateScheduleBackupWithNamespaceLabelWithValidation(ctx, schBackupSingleNS, SourceClusterName, backupLocationName, backupLocationUID, appContextsExpectedInBackup, nil, BackupOrgID, "", "", "", "", labelForSingleNamespace, periodicSchPolicyName, periodicSchPolicyUid, nil)
		...
		Step("Creating a schedule backup for multiple applications with namespace label filter", func() {
			...
			appContextsExpectedInBackup := FilterAppContextsByNamespace(scheduledAppContexts, multipleNamespace)
			firstSchBackupForMultipleNS, err = CreateScheduleBackupWithNamespaceLabelWithValidation(ctx, schBackupMultipleNS, SourceClusterName, backupLocationName, backupLocationUID, appContextsExpectedInBackup, nil, BackupOrgID, "", "", "", "", labelForMultipleNamespace, periodicSchPolicyName, periodicSchPolicyUid, nil)
		...
		Step("Creating a schedule backup for all applications with namespace label filter", func() {
			...
			appContextsExpectedInBackup := FilterAppContextsByNamespace(scheduledAppContexts, bkpNamespaces)
			firstSchBackupForAllNS, err = CreateScheduleBackupWithNamespaceLabelWithValidation(ctx, schBackupAllNS, SourceClusterName, backupLocationName, backupLocationUID, appContextsExpectedInBackup, nil, BackupOrgID, "", "", "", "", labelForAllNamespace, periodicSchPolicyName, periodicSchPolicyUid, nil)
...
var _ = Describe("{NamespaceLabelledBackupOfEmptyNamespace}", func() {
	...
	It("Namespace labelled backup of empty namespace and restore it", func() {
		...
		Step("Creating a schedule backup of empty namespace with namespace label filter", func() {
			...
			firstScheduleBackupName, err = CreateScheduleBackupWithNamespaceLabelWithValidation(ctx, scheduleName, SourceClusterName, backupLocationName, backupLocationUID, scheduledAppContextsExpectedToBeInBackup, nil, BackupOrgID, "", "", "", "", labelForNamespace, periodicSchedulePolicyName, periodicSchedulePolicyUid, nil)
