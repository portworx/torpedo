...
var _ = Describe("{NodeCountForLicensing}", func() {, Label(TestCaseLabelsMap[NodeCountForLicensing]...), 
	var (
...
var _ = Describe("{LicensingCountWithNodeLabelledBeforeClusterAddition}", func() {, Label(TestCaseLabelsMap[LicensingCountWithNodeLabelledBeforeClusterAddition]...), 
	var (
...
var _ = Describe("{LicensingCountBeforeAndAfterBackupPodRestart}", func() {, Label(TestCaseLabelsMap[LicensingCountBeforeAndAfterBackupPodRestart]...), 
	var (
		pxbNamespace                  string
		sourceClusterWorkerNodes      []node.Node
		destinationClusterWorkerNodes []node.Node
