...
require (
	...
	github.com/rancher/rancher/pkg/client v0.0.0-20240607191740-3142335ab9b3
	github.com/rancher/shepherd v0.0.0-20240603173138-6d1ffee9eb86
...
require (
	...
	github.com/google/wire v0.4.0 // indirect; indirectf
