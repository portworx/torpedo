...
func GetAWSDetailsFromEnv() (id string, secret string, endpoint string,
	s3Region string, disableSSLBool bool, sseType string) {
	...
	return id, secret, endpoint, s3Region, disableSSLBool, sseType
}
...
func GetS3Objects(clusterID string, nodeName string, getPreviousFolder bool) ([]Object, error) {
	id, secret, endpoint, s3Region, disableSSLBool, _ := GetAWSDetailsFromEnv()
